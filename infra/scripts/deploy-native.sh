...
#
# Use this when docker isn't available on the target host (the sxyin GPU
...
#
# Usage:
#   GSFLUENT_V2_HOME=/data/yinshaoxuan/gsfluent_v2 \
#   GSFLUENT_V2_PYTHON=/data/yinshaoxuan/miniconda3/bin/python \
