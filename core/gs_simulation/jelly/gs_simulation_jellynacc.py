        ...
        if args.render_img:
            ...
            if color_flag:
                if  light_flag : 
                    ...
                    command = f'cd $GSFLUENT_SIM_HOME/ && source $(conda info --base)/etc/profile.d/conda.sh && conda activate GaussianFluent && python normal_vector_proc_nan.py --npy_path {npy_path} --output_folder {output_folder}'
                    ...
                    command = f'cd $GSFLUENT_SIM_HOME/ && source $(conda info --base)/etc/profile.d/conda.sh && conda activate GaussianFluent && python phong_model_wm_shs_15.py \
