...
#
# Usage:
#   ./start-gsfluent-server.sh          # use built-in defaults (sxyin-host layout)
#
...
# ---- defaults (match the current sxyin-host deployment) --------------
: "${GSFLUENT_SIM_HOME:=/data/yinshaoxuan/GaussianFluent}"
: "${GSFLUENT_SIM_PYTHON:=/data/yinshaoxuan/miniconda3/envs/GaussianFluent/bin/python}"
: "${GSFLUENT_BIN:=/data/yinshaoxuan/miniconda3/envs/gsfluent-api/bin/gsfluent}"
: "${PKG_ROOT:=/data/yinshaoxuan/gsfluent_pkg_tmp}"
: "${PORT:=18080}"
: "${HOST:=0.0.0.0}"
